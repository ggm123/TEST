	...
	if (can->sendBuffer.can_id == 0x03)
		{
	...
	else  if(can->sendBuffer.can_id==0x201)
		 {
			 ...
			 can->sendBuffer.data[1] = 0x00;
			 can->sendBuffer.data[2] = 0x00;
			 can->sendBuffer.data[3] = 40;//Transform_Velocity_Data2.AGV_Idata[0]; //每增加1转速增加0.09375r/min  40 06=150r/min
			 can->sendBuffer.data[4] = 06;//Transform_Velocity_Data3.AGV_Idata[0];//每增加1转速增加24r/min
			 can->sendBuffer.data[5] = 0x00;
	 }
	else
	{
